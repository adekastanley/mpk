...
export default function Hero() {
	return (
		<div className=" bg-amber-400/10 mask-b-from-90% mask-b-to-100% ">
			<div className="h-screen text-center max-w-7xl mx-auto lg:min-w-7xl  gap-2 w-full flex flex-col justify-end items-center relative">
				<div className="bg-purple-300 absolute bottom-50">
					...
					<div className="absolute bg-red-900 w-100 h-100 -z-1 right-5 blur-3xl rounded-full top bg-radial-[at_50%_100%] opacity-30 from-mpk-primary via-blue-400  to-transparent"></div>
				</div>
